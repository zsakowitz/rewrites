    ...
    switch (node.type) {
            ...
            if (name.includes("_")) {
                ...
                return {
                    output:
                            ...
                            beginning + "_" + curlyBracketize(end)
                        :   beginning,
                    precedence: Precedence.Atom,
                }
            }
        ...
        case "*": {
            ...
            if (
                ...
                return {
                    output:
                        printLaTeX(node.left) + " " + parenthesize(node.right),
        ...
        case "list":
            return {
                output:
                    "\\left["
                    + node.elements.map(printLaTeX).join(",")
                    + "\\right]",
                precedence: Precedence.Atom,
            }
        ...
        case "square_root":
            if (node.complex) {
                return {
                    output:
                        "c_{sqrt}\\left(" + printLaTeX(node.arg) + "\\right)",
                    precedence: Precedence.Atom,
                }
            }
