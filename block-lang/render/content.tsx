...
function getPaddingSize(
    ...
    const contentShape =
        ...
        : content.type == "boolean" ? "sharp"
        : content.type == "field" ? "round"
    ...
    if (contentShape == "round") {
        return (
            isStatement ? 8
            : shape == "sharp" && isEmbedded ? 24
            : shape == "rect" || shape == "round" ? 4
            : 20
        )
    }
...
export function renderContent(
    ...
    const minimumWidth =
        content.type == "block" || content.type == "tail" ? 60
        : content.type == "head" ? 104
        : content.type == "sharp" ? height + 16
        : content.type == "rect" ? 48
        : height + 8
