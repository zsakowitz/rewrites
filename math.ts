...
export type ToArray<T extends number, Acc extends Array = Empty> =
...
export type SubtractArrays<A extends Array, B extends Array> =
    A extends [...B, ...infer U] ? U : Empty
...
export type DecrementArray<T extends Array> =
    T extends [any, ...infer U] ? U : Empty
...
export type ModuloArrays<A extends Array, B extends Array> =
    A extends [...B, ...infer R] ? ModuloArrays<R, B> : A
...
export type IsGTEArray<A extends Array, B extends Array> =
