        ...
        namespace Helpers {
            ...
            type OmitFunctionsAndConstantsAndEventsAndReadonly<T> = {
                [K in keyof T as T[K] extends (...args: readonly any[]) => any ?
                    never
                : K extends Uppercase<K & string> ? never
            ...
            > =
                Source extends Requirement ?
                    EventMapToProps<
                        Omit<EventMap, keyof HTMLElementEventMap>,
                        Source
                    >
                :   {}
            ...
            type CSSProps = {
                [K in keyof CSSStyleDeclaration as CSSStyleDeclaration[K] extends (
                    ...
                    never
                : K extends number | "length" | "parentRule" ? never
            ...
            type HTMLProps<T> =
                OmitFunctionsAndConstantsAndEventsAndReadonly<T> & {
                    children: Element
                    use: (el: T) => void
                    style:
                        | string
            ...
            type NullableIfPropsCanBeEmpty<T> =
                Partial<Record<keyof T, undefined>> extends T ? null | undefined
                :   never
        }
    }
}
