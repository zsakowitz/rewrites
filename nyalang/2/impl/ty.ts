        ...
        switch (this.k as T) {
            ...
            case T.Tuple: {
                ...
                return (
                    ...
                    && src.every((x, i) => x.eq(dst[i]!, params))
                )
            }
            case T.ArrayFixed: {
            ...
            case T.ArrayCapped: {
                ...
                return (
                    src.el.eq(dst.el, params) && src.size.eqTo(dst.size, params)
                )
            }
            case T.ArrayUnsized: {
            ...
            case T.Adt: {
                ...
                return (
                    ...
                    && src.consts.every((x, i) =>
                        x.eqTo(dst.consts[i]!, params),
                    )
                )
            }
            case T.Fn: {
    ...
    #const(this: Ty): boolean {
        switch (this.k as T) {
            ...
            case T.Adt: {
                const src = this.of as TyData[T.Adt]
                return (
                    src.tys.every((x) => x.const)
                    && src.consts.every((x) => x.const)
                )
            }
            case T.Option: {
                const src = this.of as TyData[T.Option]
